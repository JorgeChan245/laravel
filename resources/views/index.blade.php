    ...
    <section id="hero" class="hero section light-background">
      ...
      <div class="container position-relative">
        ...
        <div class="welcome position-relative" data-aos="fade-down" data-aos-delay="100">
          <h2>Bienvenido</h2>
          <p>Al centro de atencion SIS Medical </p>
        </div><!-- End Welcome -->
          ...
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="why-box" data-aos="zoom-out" data-aos-delay="200">
              ...
              <div class="text-center">
                <a href="{{url('login')}}" class="more-btn"><span>reserva ahora</span> <i class="bi bi-chevron-right"></i></a>
              </div>
            </div>
          </div><!-- End Why Box -->
               ...
               <!-- End Icon Box -->
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box" data-aos="zoom-out" data-aos-delay="400">
                    <i class="bi bi-gem"></i>
                    <h4>clinicas para sus especialidades</h4>
                    <p>contamos con buenas instalaciones para su mayor comodidad y satisfaccion del cliente</p>
                  </div>
                </div><!-- End Icon Box -->
